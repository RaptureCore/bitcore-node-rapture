...
/**
 * Will return the path and default bitcore-node-rapture configuration. It will search for the
...
function getDefaultConfig(options) {
  ...
  var defaultConfigFile = path.resolve(defaultPath, './bitcore-node-rapture.json');
      ...
      servicesConfig: {
        bitcoind: {
          spawn: {
            ...
            exec: path.resolve(__dirname, defaultPath, './data/raptured')
          }
        }
      }
    };
