...
/**
 * Will return the path and bitcore-node-rapture configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'bitcore-node-rapture.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'bitcore-node-rapture.json'))
  };
}
